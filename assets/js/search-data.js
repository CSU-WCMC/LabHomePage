...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/al-folio/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/en/publications/";
          },
        },{id: "nav-论文",
          title: "论文",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/zh/publications/";
          },
        },{id: "nav-projects",
          title: "projects",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/en/projects/";
          },
        },{id: "nav-项目",
          title: "项目",
          description: "项目展示与进展。",
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/zh/projects/";
          },
        },{id: "nav-repositories",
          title: "repositories",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/en/repositories/";
          },
        },{id: "nav-代码仓库",
          title: "代码仓库",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/zh/repositories/";
          },
        },{id: "nav-cv",
          title: "CV",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/en/cv/";
          },
        },{id: "nav-简历",
          title: "简历",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/zh/cv/";
          },
        },{id: "nav-teaching",
          title: "teaching",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/en/teaching/";
          },
        },{id: "nav-教学",
          title: "教学",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/zh/teaching/";
          },
        },{id: "nav-people",
          title: "people",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/en/people/";
          },
        },{id: "nav-团队成员",
          title: "团队成员",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/zh/people/";
          },
